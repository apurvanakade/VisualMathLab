...
/* Both floating panels hide themselves when they have nothing in them: the
...
/* The site's grid overlay bar expects one cell per slider, so each becomes a
...
/* Reading instructions for an overlay, sat directly under it. */
.ojs-demo-caption {
