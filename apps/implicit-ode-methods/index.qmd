...
date: 2026-07-13
order: 2
image: implicit-ode-methods.png
categories:
  - Computational Math
...
which requires solving for $y_{i+1}$ at each step (this page uses a few steps of [Newton's method](../newton-method/index.qmd)) — but buys **stability** that explicit Euler lacks. The default example, $y' = -5y$, is chosen to make this visible: try dragging $n$ down to see explicit Euler destabilize while implicit Euler stays smooth.
