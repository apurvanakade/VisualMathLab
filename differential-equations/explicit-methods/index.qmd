...
methodColors = new Map([
  ["Reference solution", "#2563eb"],
  ["Euler's method", "#dc2626"],
  ["Improved Euler", "#f59e0b"],
  ["RK4", "#16a34a"]
])
...
mainPlot = {
  ...
  return (data, showRefSolution, showEuler, showImprovedEuler, showRK4) => {
    ...
    if (showRefSolution) {
      traces.push({x: data.refTs, y: data.refYs, type: "scatter", mode: "lines", name: "Reference solution", showlegend: false, line: {color: "#2563eb", width: 3}})
    }
