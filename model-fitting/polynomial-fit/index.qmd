...
<div class="example-grid">
  <a class="example-card" href="?noise=0&degrees=1,5&seed=101">
    <h3>No noise</h3>
    <p>Compare a line with a degree-5 polynomial when all points are exactly colinear.</p>
  </a>

  <a class="example-card" href="?noise=0.25&degrees=1,2,5&seed=202">
    <h3>Small noise</h3>
    <p>Watch mild noise move the data while degree 5 bends more sharply than lower-degree fits.</p>
  </a>

  <a class="example-card" href="?noise=0.7&degrees=1,5&seed=303">
    <h3>Underfitting vs overfitting</h3>
    <p>Compare the rigid degree-1 fit with the highly flexible degree-5 interpolating fit.</p>
  </a>

  <a class="example-card" href="?noise=1&degrees=1,2,3,4,5&seed=404">
    <h3>Training error decreases</h3>
    <p>Show every degree and use the error plot to see training error fall as complexity rises.</p>
  </a>

  <a class="example-card" href="?noise=1&degrees=5&seed=505">
    <h3>Degree 5 interpolation</h3>
    <p>With six data points, degree 5 has enough parameters to pass almost exactly through all of them.</p>
  </a>

  <a class="example-card" href="?noise=1&degrees=1&seed=505">
    <h3>Same data, linear model</h3>
    <p>Use the same seed as the interpolation example, but fit only a line for direct comparison.</p>
  </a>
</div>
```
