...
examples = [
  {
    ...
    params: {f: "sin(x)", a: "0", b: "pi", max: "40", n: "6", show: ["Left Riemann sum", "Midpoint Riemann sum", "Trapezoidal rule", "Simpson's rule"]}
  },
  {
    title: "Symmetric cosine arch",
    params: {f: "cos(x)", a: "-pi/2", b: "pi/2", max: "40", n: "8", show: ["Midpoint Riemann sum", "Trapezoidal rule", "Simpson's rule"]}
  },
  {
    title: "Signed area cancellation",
    params: {f: "x^3 - x", a: "-2", b: "2", max: "40", n: "6", show: ["Left Riemann sum", "Midpoint Riemann sum", "Trapezoidal rule", "Simpson's rule"]}
  },
  {
    title: "Quadratic test case",
    params: {f: "x^2", a: "0", b: "1", max: "30", n: "5", show: ["Left Riemann sum", "Midpoint Riemann sum", "Trapezoidal rule", "Simpson's rule"]}
  },
  {
    title: "Polynomial with changing curvature",
    params: {f: "x^3 - 2*x + 1", a: "-1", b: "2", max: "40", n: "6", show: ["Left Riemann sum", "Midpoint Riemann sum", "Trapezoidal rule", "Simpson's rule"]}
  },
  {
    title: "Rational peak",
    params: {f: "1/(1 + x^2)", a: "-5", b: "5", max: "60", n: "10", show: ["Left Riemann sum", "Midpoint Riemann sum", "Trapezoidal rule", "Simpson's rule"]}
  },
  {
    title: "Gaussian bump",
    params: {f: "exp(-x^2)", a: "-3", b: "3", max: "60", n: "10", show: ["Midpoint Riemann sum", "Trapezoidal rule", "Simpson's rule"]}
  },
  {
    title: "Nonsmooth corner",
    params: {f: "abs(x)", a: "-2", b: "2", max: "50", n: "8", show: ["Left Riemann sum", "Midpoint Riemann sum", "Trapezoidal rule", "Simpson's rule"]}
  },
  {
    title: "Oscillatory integral",
    params: {f: "sin(5*x)", a: "0", b: "2*pi", max: "80", n: "12", show: ["Left Riemann sum", "Midpoint Riemann sum", "Trapezoidal rule", "Simpson's rule"]}
  },
  {
    title: "Simpson's rule needs even n",
    params: {f: "sin(x)", a: "0", b: "pi", max: "35", n: "5", show: ["Simpson's rule"]}
  }
]
```
