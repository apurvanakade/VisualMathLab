...
methodOptions = ["Left Riemann sum", "Midpoint Riemann sum", "Trapezoidal rule", "Simpson's rule"]
...
Numerical integration replaces a complicated area under a curve by areas that
are easier to compute: rectangles for Riemann sums, trapezoids for the
trapezoidal rule, and parabolic arcs for Simpson's rule.

The examples below illustrate smooth functions, cancellation from signed area,
peaked functions, rapid decay, oscillation, and the special even-subinterval
requirement for Simpson's rule.
...
<div class="example-grid">
  ...
  <a class="example-card" href="?f=sin(x)&a=0&b=pi&n=6&max=40&show=left,midpoint,trapezoidal,simpson">
    <div class="example-card-title">Sine area on one half-period</div>
    <div class="example-card-formula">f(x) = sin(x), &nbsp; [a,b] = [0,π]</div>
    <div class="example-card-text">
      A standard positive-area example. The exact integral is 2, and the
      midpoint, trapezoidal, and Simpson estimates converge quickly as n grows.
    </div>
  </a>

  <a class="example-card" href="?f=cos(x)&a=-pi%2F2&b=pi%2F2&n=8&max=40&show=midpoint,trapezoidal,simpson">
    <div class="example-card-title">Symmetric cosine arch</div>
    <div class="example-card-formula">f(x) = cos(x), &nbsp; [a,b] = [−π/2,π/2]</div>
    <div class="example-card-text">
      A smooth symmetric curve with positive area. This is a good comparison
      of midpoint, trapezoidal, and Simpson's rule without the left rectangles.
    </div>
  </a>

  <a class="example-card" href="?f=x%5E3%20-%20x&a=-2&b=2&n=6&max=40&show=left,midpoint,trapezoidal,simpson">
    <div class="example-card-title">Signed area cancellation</div>
    <div class="example-card-formula">f(x) = x³ − x, &nbsp; [a,b] = [−2,2]</div>
    <div class="example-card-text">
      The function is odd and the interval is symmetric, so positive and
      negative areas cancel. The true signed integral is 0.
    </div>
  </a>

  <a class="example-card" href="?f=x%5E2&a=0&b=1&n=5&max=30&show=left,midpoint,trapezoidal,simpson">
    <div class="example-card-title">Quadratic test case</div>
    <div class="example-card-formula">f(x) = x², &nbsp; [a,b] = [0,1]</div>
    <div class="example-card-text">
      Simpson's rule is exact for quadratics when n is even. Try changing n
      and compare it with the rectangle and trapezoidal estimates.
    </div>
  </a>

  <a class="example-card" href="?f=x%5E3%20-%202*x%20%2B%201&a=-1&b=2&n=6&max=40&show=left,midpoint,trapezoidal,simpson">
    <div class="example-card-title">Polynomial with changing curvature</div>
    <div class="example-card-formula">f(x) = x³ − 2x + 1, &nbsp; [a,b] = [−1,2]</div>
    <div class="example-card-text">
      A polynomial example where the graph bends in different ways across the
      interval. Simpson's parabolic pieces often capture this behavior well.
    </div>
  </a>

  <a class="example-card" href="?f=1%2F(1%20%2B%20x%5E2)&a=-5&b=5&n=10&max=60&show=left,midpoint,trapezoidal,simpson">
    <div class="example-card-title">Rational peak</div>
    <div class="example-card-formula">f(x) = 1/(1+x²), &nbsp; [a,b] = [−5,5]</div>
    <div class="example-card-text">
      A bell-shaped rational function with most of its area near the origin.
      More subintervals are needed to resolve the central peak accurately.
    </div>
  </a>

  <a class="example-card" href="?f=exp(-x%5E2)&a=-3&b=3&n=10&max=60&show=midpoint,trapezoidal,simpson">
    <div class="example-card-title">Gaussian bump</div>
    <div class="example-card-formula">f(x) = exp(−x²), &nbsp; [a,b] = [−3,3]</div>
    <div class="example-card-text">
      A smooth rapidly decaying function. Higher-order methods converge very
      quickly because the curve is smooth across the whole interval.
    </div>
  </a>

  <a class="example-card" href="?f=abs(x)&a=-2&b=2&n=8&max=50&show=left,midpoint,trapezoidal,simpson">
    <div class="example-card-title">Nonsmooth corner</div>
    <div class="example-card-formula">f(x) = |x|, &nbsp; [a,b] = [−2,2]</div>
    <div class="example-card-text">
      The graph has a sharp corner at x = 0. This shows how nonsmoothness can
      affect the usual convergence behavior.
    </div>
  </a>

  <a class="example-card" href="?f=sin(5*x)&a=0&b=2*pi&n=12&max=80&show=left,midpoint,trapezoidal,simpson">
    <div class="example-card-title">Oscillatory integral</div>
    <div class="example-card-formula">f(x) = sin(5x), &nbsp; [a,b] = [0,2π]</div>
    <div class="example-card-text">
      Positive and negative waves cancel over the full interval. Increase n to
      see how the methods handle rapidly oscillating signed area.
    </div>
  </a>

  <a class="example-card" href="?f=sin(x)&a=0&b=pi&n=5&max=35&show=simpson">
    <div class="example-card-title">Simpson's rule needs even n</div>
    <div class="example-card-formula">f(x) = sin(x), &nbsp; [a,b] = [0,π], &nbsp; n = 5</div>
    <div class="example-card-text">
      Simpson's rule is only defined for an even number of subintervals in this
      app. With odd n, the table leaves Simpson's estimate as NaN.
    </div>
  </a>
