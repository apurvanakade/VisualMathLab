...
<div class="example-grid">
  <a class="example-card" href="?f=sin(x)&a=0&b=2*pi&n=4&max=20&show=original,linear,cubic">
    <h3>Sine on one full period</h3>
    <p>Compare linear and cubic spline interpolation for a smooth periodic curve.</p>
  </a>

  <a class="example-card" href="?f=cos(x)&a=0&b=pi&n=3&max=24&show=original,linear,cubic">
    <h3>Cosine on half a period</h3>
    <p>Start with only a few subintervals and watch the arc length estimates converge.</p>
  </a>

  <a class="example-card" href="?f=x%5E3-x&a=-2&b=2&n=4&max=30&show=original,linear,cubic">
    <h3>Cubic polynomial</h3>
    <p>Use a curve with turning behavior to see how splines reduce visible cornering.</p>
  </a>

  <a class="example-card" href="?f=1%2F(1%2Bx%5E2)&a=-5&b=5&n=6&max=40&show=original,linear,cubic">
    <h3>Rational peak</h3>
    <p>Interpolate a peaked function over a wider interval and compare arc length errors.</p>
  </a>

  <a class="example-card" href="?f=exp(-x%5E2)&a=-3&b=3&n=5&max=35&show=original,linear,cubic">
    <h3>Gaussian bump</h3>
    <p>See how the interpolants behave on a smooth curve that flattens near the endpoints.</p>
  </a>

  <a class="example-card" href="?f=abs(x)&a=-2&b=2&n=4&max=30&show=original,linear,cubic">
    <h3>Nonsmooth corner</h3>
    <p>Try a sharp cusp where cubic splines may overshoot near the corner.</p>
  </a>
</div>
```
