...
mainPlot = {
  ...
  return (data, showOriginal, showLinear, showCubic, showNodes) => {
    ...
    if (showNodes && data.nodesX.length > 0) {
      traces.push({x: data.nodesX, y: data.nodesY, type: "scatter", mode: "markers", name: "Interpolation nodes", showlegend: false, marker: {color: chartColors.ink, size: 8, symbol: "circle", line: {color: "white", width: 1}}})
    }
