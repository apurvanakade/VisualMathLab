...
examples = [
  {
    ...
    params: {f: "sin(x)", sigma: "0.4", b: "20", seed: "1", max: "60", alpha: 0.9, k: 5, R: 0.16, Q: 0.05, show: ["True Signal", "Simple Moving Average", "Exponential Moving Average", "Kalman Filter"]}
  },
  {
    title: "Estimating a hidden constant",
    params: {f: "5", sigma: "1", b: "20", seed: "3", max: "60", alpha: 0.9, k: 8, R: 1, Q: 0, show: ["True Signal", "Kalman Filter", "Exponential Moving Average"]}
  },
  {
    title: "Sudden regime change",
    params: {f: "x > 10 ? 6 : 0", sigma: "0.5", b: "20", seed: "2", max: "80", alpha: 0.9, k: 8, R: 0.25, Q: 0.05, show: ["True Signal", "Simple Moving Average", "Exponential Moving Average", "Kalman Filter"]}
  },
  {
    title: "Fast oscillation exposes lag",
    params: {f: "sin(3*x)", sigma: "0.3", b: "10", seed: "4", max: "100", alpha: 0.9, k: 6, R: 0.09, Q: 0.05, show: ["True Signal", "Simple Moving Average", "Exponential Moving Average", "Kalman Filter"]}
  },
  {
    title: "Heavy noise, gentle signal",
    params: {f: "cos(x/2)", sigma: "0.8", b: "25", seed: "5", max: "80", alpha: 0.95, k: 12, R: 0.64, Q: 0.02, show: ["True Signal", "Simple Moving Average", "Exponential Moving Average", "Kalman Filter"]}
  },
  {
    title: "Tracking a steady drift",
    params: {f: "0.3*x", sigma: "1", b: "15", seed: "6", max: "60", alpha: 0.85, k: 6, R: 1, Q: 0.1, show: ["True Signal", "Exponential Moving Average", "Kalman Filter"]}
  },
  {
    title: "Overconfident sensor model",
    params: {f: "sin(x)", sigma: "0.6", b: "20", seed: "7", max: "60", alpha: 0.9, k: 5, R: 0.01, Q: 0.05, show: ["True Signal", "Kalman Filter"]}
  },
  {
    title: "Zero process noise stops tracking",
    params: {f: "sin(x)", sigma: "0.3", b: "20", seed: "8", max: "60", alpha: 0.9, k: 5, R: 0.09, Q: 0, show: ["True Signal", "Kalman Filter", "Exponential Moving Average"]}
  }
]
```
...
viewof methods = {
  ...
  checkboxInput.dataset.exampleField = "show"
