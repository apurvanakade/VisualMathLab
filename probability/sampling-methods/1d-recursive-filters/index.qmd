...
methodOptions = ["True Signal", "Simple Moving Average", "Exponential Moving Average", "Kalman Filter"]
...
mainPlot = {
  ...
  return (rows, data, showTrueSignal, showSMA, showEMA, showKalman) => {
    const traces = []
    if (showTrueSignal) {
      traces.push({x: data.refXs, y: data.refYs, type: "scatter", mode: "lines", name: "True signal", showlegend: true, line: {color: "#2563eb", width: 3}})
    }
...
```{ojs}
mainPlot(result.rows, setup, showTrueSignal, showSMA, showEMA, showKalman)
```
...
<div class="example-grid">
  ...
  <a class="example-card" href="?f=sin(x)&sigma=0.4&b=20&seed=1&max=60&alpha=0.9&k=5&R=0.16&Q=0.05&show=true,sma,ema,kalman">
  ...
  <a class="example-card" href="?f=5&sigma=1&b=20&seed=3&max=60&alpha=0.9&k=8&R=1&Q=0&show=true,kalman,ema&tab=filters">
  ...
  <a class="example-card" href="?f=x%20%3E%2010%20%3F%206%20%3A%200&sigma=0.5&b=20&seed=2&max=80&alpha=0.9&k=8&R=0.25&Q=0.05&show=true,sma,ema,kalman">
  ...
  <a class="example-card" href="?f=sin(3*x)&sigma=0.3&b=10&seed=4&max=100&alpha=0.9&k=6&R=0.09&Q=0.05&show=true,sma,ema,kalman">
  ...
  <a class="example-card" href="?f=cos(x%2F2)&sigma=0.8&b=25&seed=5&max=80&alpha=0.95&k=12&R=0.64&Q=0.02&show=true,sma,ema,kalman">
  ...
  <a class="example-card" href="?f=0.3*x&sigma=1&b=15&seed=6&max=60&alpha=0.85&k=6&R=1&Q=0.1&show=true,ema,kalman">
  ...
  <a class="example-card" href="?f=sin(x)&sigma=0.6&b=20&seed=7&max=60&alpha=0.9&k=5&R=0.01&Q=0.05&show=true,kalman&tab=filters">
  ...
  <a class="example-card" href="?f=sin(x)&sigma=0.3&b=20&seed=8&max=60&alpha=0.9&k=5&R=0.09&Q=0&show=true,kalman,ema&tab=filters">
