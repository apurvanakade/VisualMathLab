...
traceOptions = ["f(x)", "y = 0", "Previous midpoints", "Endpoints", "Midpoint", "Exact root found"]
...
mainPlot = {
  ...
  return ({visibleRows, currentRow, xRange, xBuffer, yRange, sampleXs, sampleYs}, showFCurve, showZeroLine, showPrevMidpoints, showEndpoints, showMidpoint, showExactRoot) => {
    const data = []
...
```{ojs}
mainPlot(setup, showFCurve, showZeroLine, showPrevMidpoints, showEndpoints, showMidpoint, showExactRoot)
```
