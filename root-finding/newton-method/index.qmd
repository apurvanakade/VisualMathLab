...
// overlay legend's swatches double as a color key. Reads the theme once at
// page load (js/plotting/chart-theme.js) -- like every trace color on this
// page, it doesn't reactively repaint on a dark-mode toggle mid-session,
// only on next load; the chart's background/axes/gridlines do repaint
// live, via the shared Plotly.newPlot/react patch in
// plotly-fullscreen-button.js.
