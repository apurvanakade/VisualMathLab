...
traceOptions = ["f(x)", "y = 0", "Tangent line", "Newton points", "Tangent x-intercepts"]
...
mainPlot = {
  ...
  return ({visibleRows, xRange, xBuffer, yRange, sampleXs, sampleYs}, showFCurve, showZeroLine, showTangent, showNewtonPoints, showIntercepts) => {
    const data = []
...
```{ojs}
mainPlot(setup, showFCurve, showZeroLine, showTangent, showNewtonPoints, showIntercepts)
```
